		...
		<div id="page">
			...
			<main id="content">
				<div id="tickets">
					...
					<ul>
						<li class="first">
							<div><a href="#"><img src="images/ticket-lion.jpg" alt="лева"/></a></div>
							...
							<span>Взрослый -  9.0р</span>
							<span>Детский -  4.0р</span>
						</li>
						<li>
							<div><a href="#"><img src="images/ticket-dolphin.jpg" alt="дельфин"/></a></div>
                    ...
                    <form action="order.php">
                        <input type="submit" value="заказать" color="white">
                    </form>
